...
public class SlideView extends RelativeLayout implements AppCompatSeekBar.OnSeekBarChangeListener{
    ...
    void init(AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            int buttonImageId = a.getResourceId(R.styleable.SlideView_buttonImage, R.drawable.ic_sos_black);
